...
class TestHand:
    def test_hand_materials(self):
        ...
        hand.update_material(0, 1)
        hand.update_material(1, 1)
        hand.update_material(2, 1)
        hand.update_material(3, 1)
        hand.update_material(4, 1)
        ...
        hand.update_material_list([0, 1, 2, 3, 4], 1)
